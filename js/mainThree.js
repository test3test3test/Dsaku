...
// import {VRM} from 'https://unpkg.com/@pixiv/three-vrm@0.3.0/lib/three-vrm.js';
...
class LoadModelDemo {
    ...
    _LoadAnimatedModel() {
        ...
        loader.load('D-saku.fbx', (fbx) => {
          ...
          anim.setPath('./js/resources/zombie/');
    ...
    _LoadModel() {
        ...
        loader.load('./js/resources/thing.glb', (gltf) => {
